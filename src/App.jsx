...
import Resume from './Shafinul Islam Resume.pdf'
import { motion } from 'framer-motion'
import { Player } from '@lottiefiles/react-lottie-player'
import { FaFacebook, FaInstagram, FaGithub, FaFileDownload } from 'react-icons/fa'
      ...
      <section className="flex flex-col justify-evenly items-center snap-y snap-mandatory snap-center h-screen">
        ...
        >
          <p className='text-sm md:text-base lg:text-2xl'>
            ...
            occasional challenge. Besides that, I am an avid car enthusiast and will blabber a lot about 
            cars with a fellow enthusiast. Finally, I take amateur pictures, mostly of the sky.
            </p>`}
          </p>
        </motion.div>
      </section>
